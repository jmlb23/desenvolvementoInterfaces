========================================================================
    APLICACIÓN DE WIN32: ConsoleApplication5 Información general del proyecto
========================================================================
...
ConsoleApplication5.ico
    Éste es un archivo de icono, que se utiliza como el icono de la aplicación (32x32). Este icono está incluido en el archivo principal de recursos ConsoleApplication5.rc.

small.ico
    Este es un archivo de icono, que contiene una versión menor (16x16) del icono de la aplicación. Este icono está incluido en el archivo principal de recursos ConsoleApplication5.rc.
